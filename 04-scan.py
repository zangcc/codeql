...
if inputParameter2 == "java":
    lombokCommands          = ['java -jar delombokJarFilePath delombok -n --onlyChanged . -d "delombok"'.replace("delombokJarFilePath",delombokJarFilePath),'find "delombok" -name \'*.java\' -exec sed \'/Generated by delombok/d\' -i \'{}\' \';\'','find "delombok" -name \'*.java\' -exec sed \'/import lombok/d\' -i \'{}\' \';\'','cp -r "delombok/." "./"','rm -rf "delombok"']
...
mvCodeqlDatabaseDirCmd2     =  "mv " + codeqlDatabasePath + " " + root_path + "/" + str(getCurrentTime())+"_"+str(getCodeRespName(inputParameter1))+"_codeqldatabase;"
