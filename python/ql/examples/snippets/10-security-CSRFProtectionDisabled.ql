...
select setting, setting.getLocation().getFile().getAbsolutePath()+"$$"+setting.getLocation().getStartLine(),"Potential CSRF vulnerability due to forgery protection being disabled or weakened."
