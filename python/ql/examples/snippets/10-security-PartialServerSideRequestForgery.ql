...
select request, source, sink,sink.getNode().getLocation().getFile().getAbsolutePath()+"$$"+sink.getNode().getLocation().getStartLine(), "Part of the URL of this request depends on a $@.", source.getNode(),
  "user-provided value"
