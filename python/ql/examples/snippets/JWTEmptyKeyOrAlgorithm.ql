...
select jwtEncoding.getLocation().getFile().getAbsolutePath()+"$$"+jwtEncoding.getLocation().getStartLine() ,jwtEncoding, "This JWT encoding has an empty " + affectedComponent + "."
