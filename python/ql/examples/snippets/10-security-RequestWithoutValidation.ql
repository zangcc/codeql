...
select request, request.getLocation().getFile().getAbsolutePath()+"$$"+request.getLocation().getStartLine(),"This request may run without certificate validation because $@" + ending,
