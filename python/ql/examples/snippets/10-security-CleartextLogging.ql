...
select sink.getNode(),sink.getNode().getLocation().getFile().getAbsolutePath()+"$$"+sink.getNode().getLocation().getStartLine(), source, sink, "This expression logs $@ as clear text.", source.getNode(),
