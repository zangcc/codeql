...
select sanitizer.getLocation().getFile().getAbsolutePath()+"$$"+sanitizer.getLocation().getStartLine() ,sanitizer, "The string $@ may be at an arbitrary position in the sanitized URL.", url,
  url.getText()
