...
select ldapBind.getLocation().getFile().getAbsolutePath()+"$$"+ldapBind.getLocation().getStartLine() ,ldapBind, "The following LDAP bind operation is executed without authentication."
