...
select sanitizer,sanitizer.getLocation().getFile().getAbsolutePath()+"$$"+sanitizer.getLocation().getStartLine(), "The string $@ may be at an arbitrary position in the sanitized URL.", url,
  url.getText()
