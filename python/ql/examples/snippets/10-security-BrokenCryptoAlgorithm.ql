...
select operation, operation.getLocation().getFile().getAbsolutePath()+"$$"+operation.getLocation().getStartLine(),"$@ is broken or weak, and should not be used.", operation.getInitialization(),
  msgPrefix
