...
select node,node.getLocation().getFile().getAbsolutePath()+":"+node.getLocation().getStartLine()+":"+node.getLocation().getEndLine(), "This network call does not implement certificate pinning. " + msg
