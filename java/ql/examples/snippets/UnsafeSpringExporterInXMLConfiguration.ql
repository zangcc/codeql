...
select bean.getLocation().getFile().getAbsolutePath()+"$$"+bean.getLocation().getStartLine() ,bean, "Unsafe deserialization in a Spring exporter bean '" + bean.getBeanIdentifier() + "'."
