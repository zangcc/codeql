...
select androidAppElem.getLocation().getFile().getAbsolutePath()+"$$"+androidAppElem.getLocation().getStartLine() ,androidAppElem.getAttribute("debuggable"), "The 'android:debuggable' attribute is enabled."
