...
select call,call.getLocation().getFile().getAbsolutePath()+":"+call.getLocation().getStartLine()+"-"+call.getLocation().getEndLine(), "CSRF vulnerability due to protection being disabled."
