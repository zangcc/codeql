...
select impExpAndroidComp.getLocation().getFile().getAbsolutePath()+"$$"+impExpAndroidComp.getLocation().getStartLine() ,impExpAndroidComp, "This component is implicitly exported."
