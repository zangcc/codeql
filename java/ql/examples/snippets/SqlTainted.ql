...
select query.getLocation().getFile().getAbsolutePath()+"$$"+query.getLocation().getStartLine() ,query, source, sink, "This query depends on a $@.", source.getNode(), "user-provided value"
