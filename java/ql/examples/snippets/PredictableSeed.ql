...
select da.getLocation().getFile().getAbsolutePath()+"$$"+da.getLocation().getStartLine() ,da, "Usage of a SecureRandom number generator seeded with a $@.", source, "predictable value"
