...
select setWorldWritable.getLocation().getFile().getAbsolutePath()+"$$"+setWorldWritable.getLocation().getStartLine() ,setWorldWritable, "This sets a file is as world writable, but is read from $@.", readFrom,
  "statement"
