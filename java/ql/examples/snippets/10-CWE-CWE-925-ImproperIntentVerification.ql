...
select orm, orm.getLocation().getFile().getAbsolutePath()+":"+orm.getLocation().getStartLine()+":"+orm.getLocation().getEndLine(),"This reciever doesn't verify intents it receives, and $@ to receive $@.", reg,
