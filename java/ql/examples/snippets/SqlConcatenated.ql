...
select query.getLocation().getFile().getAbsolutePath()+"$$"+query.getLocation().getStartLine() ,query, "Query built by concatenation with $@, which may be untrusted.", uncontrolled,
  "this expression"
