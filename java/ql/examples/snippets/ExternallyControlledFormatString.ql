...
select formatCall.getLocation().getFile().getAbsolutePath()+"$$"+formatCall.getLocation().getStartLine() ,formatCall.getFormatArgument(), source, sink, "Format string depends on a $@.",
