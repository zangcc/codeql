...
select spec.getLocation().getFile().getAbsolutePath()+"$$"+spec.getLocation().getStartLine() ,spec, source, sink, "Cryptographic algorithm $@ is weak and should not be used.", algo,
  algo.getValue()
