...
select externalExpr.getLocation().getFile().getAbsolutePath()+"$$"+externalExpr.getLocation().getStartLine() ,externalExpr, "$@ can be exposed to an external user.", errorInformation, "Error information"
