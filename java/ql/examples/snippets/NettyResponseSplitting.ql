...
select new.getLocation().getFile().getAbsolutePath()+"$$"+new.getLocation().getStartLine() ,new, new.splittingType() + " vulnerability due to header value verification being disabled."
