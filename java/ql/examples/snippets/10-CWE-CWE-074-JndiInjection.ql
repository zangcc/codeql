...
select sink.getNode(), source, sink,sink.getNode().getLocation().getFile().getAbsolutePath()+"$$"+sink.getNode().getLocation().getStartLine(), "JNDI lookup might include name from $@.", source.getNode(),
  "this user input"
