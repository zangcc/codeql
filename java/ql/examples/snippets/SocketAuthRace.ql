...
select c.getLocation().getFile().getAbsolutePath()+"$$"+c.getLocation().getStartLine() ,c.nnection.getLocation().getFile().getAbsolutePath()+"$$"+connection.getLocation().getStartLine() ,connection,
