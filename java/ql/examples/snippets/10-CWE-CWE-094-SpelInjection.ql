...
select sink.getNode(), source, sink,sink.getNode().getLocation().getFile().getAbsolutePath()+"$$"+sink.getNode().getLocation().getStartLine(), "SpEL expression depends on a $@.", source.getNode(),
  "user-provided value"
