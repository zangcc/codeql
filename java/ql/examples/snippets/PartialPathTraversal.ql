...
select ma.getLocation().getFile().getAbsolutePath()+"$$"+ma.getLocation().getStartLine() ,ma, "Partial Path Traversal Vulnerability due to insufficient guard against path traversal."
