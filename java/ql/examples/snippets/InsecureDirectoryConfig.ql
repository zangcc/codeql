...
select initp.getLocation().getFile().getAbsolutePath()+"$$"+initp.getLocation().getStartLine() ,initp, "Directory listing should be disabled to mitigate filename and path disclosure."
