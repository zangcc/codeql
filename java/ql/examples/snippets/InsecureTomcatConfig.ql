...
select c.getLocation().getFile().getAbsolutePath()+"$$"+c.getLocation().getStartLine() ,c.nfig.getLocation().getFile().getAbsolutePath()+"$$"+config.getLocation().getStartLine() ,config,
