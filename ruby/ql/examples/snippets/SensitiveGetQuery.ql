...
select source.getNode().asExpr().getFile().getAbsolutePath()+"$$"+source.getNode().asExpr().getFile().getLocation().getStartLine() ,source, "$@ for GET requests uses query parameter as sensitive data.",
