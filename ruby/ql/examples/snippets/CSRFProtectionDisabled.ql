...
select s.getLocation().getFile().getAbsolutePath()+"$$"+s.getLocation().getStartLine() ,s, "Potential CSRF vulnerability due to forgery protection being disabled or weakened."
