...
select httpOnlySink.getLocation().getFile().getAbsolutePath()+"$$"+httpOnlySink.getLocation().getStartLine() ,httpOnlySink, "Cookie attribute 'HttpOnly' is not set to true."
