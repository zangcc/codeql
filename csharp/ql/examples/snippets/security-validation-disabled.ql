...
select sink.getNode().asExpr().getFile().getAbsolutePath()+"$$"+sink.getNode().asExpr().getFile().getLocation().getStartLine() ,sink, "The security sensitive property $@ is being disabled by the following value: $@.", pw,
