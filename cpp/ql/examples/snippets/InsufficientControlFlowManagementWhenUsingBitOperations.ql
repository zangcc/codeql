...
select dbo.getLocation().getFile().getAbsolutePath()+"$$"+dbo.getLocation().getStartLine() ,dbo, "This bitwise operation appears in a context where a Boolean operation is expected."
