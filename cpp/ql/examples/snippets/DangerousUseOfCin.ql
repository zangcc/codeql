...
select rshift.getLocation().getFile().getAbsolutePath()+"$$"+rshift.getLocation().getStartLine() ,rshift, "Use of 'cin' without specifying the length of the input may be dangerous."
