...
select condition, sourceNode, sinkNode,condition.getLocation().getFile().getAbsolutePath()+"$$"+condition.getLocation().getStartLine(), "Reliance on untrusted input $@ to raise privilege at $@.",
