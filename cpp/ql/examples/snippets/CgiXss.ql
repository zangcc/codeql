...
select printedArg.getLocation().getFile().getAbsolutePath()+"$$"+printedArg.getLocation().getStartLine() ,printedArg, sourceNode, sinkNode, "Cross-site scripting vulnerability due to $@.", query,
  "this query data"
