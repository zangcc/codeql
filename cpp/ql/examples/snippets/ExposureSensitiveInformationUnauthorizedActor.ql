...
select fc.getLocation().getFile().getAbsolutePath()+"$$"+fc.getLocation().getStartLine() ,fc, "You may have forgotten to restrict access rights when working with a file."
