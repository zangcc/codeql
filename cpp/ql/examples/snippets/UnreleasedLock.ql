...
select lock.getLocation().getFile().getAbsolutePath()+"$$"+lock.getLocation().getStartLine() ,lock, "This lock might not be unlocked or might be locked more times than it is unlocked."
