...
select alloc.getLocation().getFile().getAbsolutePath()+"$$"+alloc.getLocation().getStartLine() ,alloc, source, sink, "This allocation size is derived from $@ and might overflow.",
