...
select fc.getLocation().getFile().getAbsolutePath()+"$$"+fc.getLocation().getStartLine() ,fc, "The value of argument $@ appears to be checked after the call, rather than before it.",
