...
select c.getLocation().getFile().getAbsolutePath()+"$$"+c.getLocation().getStartLine() ,c.mmand.getLocation().getFile().getAbsolutePath()+"$$"+command.getLocation().getStartLine() ,command, sourceNode, sinkNode,
