...
select networkSendRecv.getLocation().getFile().getAbsolutePath()+"$$"+networkSendRecv.getLocation().getStartLine() ,networkSendRecv, source, sink, msg, source.getNode(), source.getNode().toString()
