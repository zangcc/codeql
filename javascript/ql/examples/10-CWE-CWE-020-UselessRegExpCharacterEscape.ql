...
select mistake, mistake.getRawStringNode().getFile().getAbsolutePath()+"-"+mistake.getRawStringNode().getStartLine(),"The escape sequence " + mistake.getMessage() + " when it is used in a $@.",
