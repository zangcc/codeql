...
select step.getLocation().getFile().getAbsolutePath()+"$$"+step.getLocation().getStartLine() ,step, "Potential unsafe checkout of untrusted pull request on 'pull_request_target'."
