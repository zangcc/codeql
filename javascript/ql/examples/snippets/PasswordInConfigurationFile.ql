...
select valElement.getLocation().getFile().getAbsolutePath()+"$$"+valElement.getLocation().getStartLine() ,valElement.(FirstLineOf), "Hard-coded password '" + pwd + "' in configuration file."
