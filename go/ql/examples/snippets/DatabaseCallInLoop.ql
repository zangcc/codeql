...
select dbAccess.getLocation().getFile().getAbsolutePath()+"$$"+dbAccess.getLocation().getStartLine() ,dbAccess, loop, dbAccess.asExpr(), "This calls " + dbAccess.toString() + " in a $@.", loop,
  "loop"
